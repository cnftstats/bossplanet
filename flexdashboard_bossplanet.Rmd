...
<!-- ```{r} -->
<!-- gg <- ggplot(RAR) + -->
<!--   geom_point(aes(x = xcoord, y = ycoord), color = "grey90", alpha = .8, size = .3) + -->
<!--   scale_x_continuous(breaks = c(-180, -60, +60, +180)) + -->
<!--   scale_y_continuous(breaks = c(-180, -60, +60, +180)) + -->
<!--   cowplot::theme_nothing() -->

<!-- ggsave("map_background.png", gg) -->
...
<!--   layout(images = list( -->
<!--   list( -->
<!--     # source = "https://t4.ftcdn.net/jpg/01/61/82/97/360_F_161829780_LFy5BlQ4Mg94Ql1ywUyPTMTnVeZABsfN.jpg", -->
<!--     source = "https://raw.githubusercontent.com/cnftstats/bossplanet/main/map_background.png?raw=true", -->
<!--     xref = "x", -->
<!--     yref = "y", -->
<!--     x = -180, -->
<!--     y = 179, -->
