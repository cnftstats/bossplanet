...
> Warning: `Bundles` (multiple assets listed together) are excluded! The <a href="https://www.mathsisfun.com/median.html" target="_blank">median</a> is the 'middle point' of all the listing.
...
gg <- ggplot() +
  ...
  coord_fixed(xlim = c(-180, 180), ylim = c(-60, 180))
