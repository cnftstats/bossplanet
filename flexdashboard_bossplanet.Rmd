...
<!-- gg <- plot_ly( -->
<!--   data = shared, x = ~xcoord, y = ~ycoord,  -->
<!--   # split = ~interaction(type, show_price), -->
<!--   customdata = ~link, -->
<!--   # hoverinfo = "text", -->
<!--   type = "scattergl", mode = "markers", -->
<!--   text = ~paste0(paste("Price:", round(price, 2), -->
...
<!--   gg, -->
<!--   list( -->
<!--     crosstalk::filter_checkbox("show_price",  -->
<!--                                label = "show_price", -->
<!--                                sharedData = shared,  -->
<!--                                group = ~show_price), -->
...
# Buy me a coffee (Thanks for the tip kind stranger!) {data-icon="ion-coffee"}
## Column 1
